  ...
  en: {
    translation: {
      ...
      projectList: {
        ...
        p14: { name: "AnimeBurn", status: "Anime streaming platform with complete features like bookmarking, watch history, and download mode." },
        p15: { name: "Traffic RNN", status: "Traffic prediction application using Recurrent Neural Network (RNN) for intelligent traffic analysis." },
        p16: { name: "SPK Calculator", status: "Multi-method Decision Support System calculator with detailed calculation logs." },
        p17: { name: "SawitMart", status: "Web application developed using Angular and Golang with SawitDB." },
        p18: { name: "Parfume Lux", status: "Online perfume store website with elegant design and complete product catalog features." },
        p19: { name: "Website PT.Cipta Hospital", status: "I created this website to promote PT. Cipta Hospital, in terms of services, etc. and this is to complete a project for a college assignment." },
        p20: { name: "Motion Tabs", status: "Interactive navigation menu animation implementation using pure HTML, CSS, and JavaScript." },
        p21: { name: "Login Register", status: "A responsive Login & Register interface implementation." },
      },
    },
  },
  id: {
    translation: {
      ...
      projectList: {
        ...
        p11: { name: "SPK Calculator", status: "Kalkulator Sistem Pendukung Keputusan multi-metode dengan log perhitungan detail." },
        p12: { name: "SawitMart", status: "Aplikasi web yang dikembangkan menggunakan Angular dan Golang dengan SawitDB." },
        p13: { name: "Parfume Lux", status: "Website toko online parfum dengan desain elegan dan fitur katalog produk yang lengkap." },
        p14: { name: "Website PT.Cipta Hospital", status: "Saya membuat website ini untuk mempromosikan PT. Cipta Hospital, dalam hal layanan, dll. dan ini untuk menyelesaikan proyek tugas kuliah." },
        p15: { name: "Motion Tabs", status: "Implementasi animasi menu navigasi interaktif menggunakan HTML, CSS, dan JavaScript murni." },
        p16: { name: "Login Register", status: "Implementasi antarmuka Login & Register yang responsif." },
        p17: { name: "Aplikasi Absensi Siswa", status: "Aplikasi absensi siswa berbasis web untuk memudahkan pencatatan kehadiran siswa secara digital dengan fitur lengkap dan antarmuka modern." },
        p18: { name: "Aplikasi CBT Siswa", status: "Aplikasi Computer Based Test (CBT) siswa berbasis web untuk melaksanakan ujian secara online dengan fitur manajemen soal dan penilaian otomatis." },
        p19: { name: "MangaBurn", status: "Platform baca manga & komik modern dengan fitur lengkap untuk manajemen komik, bookmark, history baca, dan sistem rating." },
        p20: { name: "AnimeBurn", status: "Anime streaming platform with complete features like bookmarking, watch history, and download mode." },
      },
    },
  },
  jp: {
    translation: {
      ...
      projectList: {
        ...
        p14: { name: "AnimeBurn", status: "ブックマーク、視聴履歴、ダウンロードモードなどの完全な機能を備えたアニメストリーミングプラットフォーム。" },
        p15: { name: "Traffic RNN", status: "インテリジェントな交通分析のためのリカレントニューラルネットワーク（RNN）を使用した交通予測アプリケーション。" },
        p16: { name: "SPK Calculator", status: "詳細な計算ログを備えたマルチメソッド意思決定支援システム計算機。" },
        p17: { name: "SawitMart", status: "AngularとGolangをSawitDBと共に使用して開発されたウェブアプリケーション。" },
        p18: { name: "Parfume Lux", status: "エレガントなデザインと充実した商品カタログ機能を備えた香水オンラインストアサイト。" },
        p19: { name: "PT.Cipta Hospital", status: "PT. Cipta Hospitalのサービスなどを宣伝するために作成しました。これは大学の課題プロジェクトを完了するためのものです。" },
        p20: { name: "ログイン登録", status: "レスポンシブなログイン＆登録インターフェースの実装。" },
      },
    },
  },
};
