  ...
  en: {
    translation: {
      ...
      projectList: {
        ...
        p20: { name: "Login Register", status: "A responsive Login & Register interface implementation." },
      },
    },
  },
  id: {
    translation: {
      ...
      projectList: {
        ...
        p15: { name: "Login Register", status: "Implementasi antarmuka Login & Register yang responsif." },
        p16: { name: "Aplikasi Absensi Siswa", status: "Aplikasi absensi siswa berbasis web untuk memudahkan pencatatan kehadiran siswa secara digital dengan fitur lengkap dan antarmuka modern." },
        p17: { name: "Aplikasi CBT Siswa", status: "Aplikasi Computer Based Test (CBT) siswa berbasis web untuk melaksanakan ujian secara online dengan fitur manajemen soal dan penilaian otomatis." },
        p18: { name: "MangaBurn", status: "Platform baca manga & komik modern dengan fitur lengkap untuk manajemen komik, bookmark, history baca, dan sistem rating." },
        p19: { name: "AnimeBurn", status: "Anime streaming platform with complete features like bookmarking, watch history, and download mode." },
      },
    },
  },
  jp: {
