  ...
  en: {
    translation: {
      ...
      projectList: {
        ...
        p4: { name: "Website Portfolio V3 Yae", status: "Latest version of my personal portfolio website with modern design and enhanced user experience." },
        p5: { name: "Website List Joki", status: "This website is created to offer game account maintenance services: daily login, leveling, and weekly events. Safe, fast, and reliable." },
        p6: { name: "Website Shiraori Joki V2", status: "Second version of Shiraori Joki website with improved design and features for game account services." },
        p7: { name: "Project PKM", status: "PKM (Program Kreativitas Mahasiswa) project website showcasing student creativity and innovation." },
        p8: { name: "Dashboard E-Commerce", status: "E-commerce dashboard for managing fresh products with complete features for inventory, sales, and reporting." },
        p9: { name: "Lumichan AI", status: "AI-powered chatbot application with intelligent conversation capabilities and modern user interface." },
        p10: { name: "Digital Library", status: "Digital library management system for organizing and managing book collections with modern interface." },
        p11: { name: "Aplikasi Absensi Siswa", status: "A web-based student attendance application to facilitate digital student attendance recording with complete features and modern interface." },
        p12: { name: "Aplikasi CBT Siswa", status: "A web-based Computer Based Test (CBT) student application for conducting online exams with question management and automatic grading features." },
        p13: { name: "MangaBurn", status: "Modern manga & comic reading platform with complete features for comic management, bookmarking, reading history, and rating system." },
        p14: { name: "Traffic RNN", status: "Traffic prediction application using Recurrent Neural Network (RNN) for intelligent traffic analysis." },
        p15: { name: "SawitMart", status: "Web application developed using Angular and Golang with SawitDB." },
        p16: { name: "Parfume Lux", status: "Online perfume store website with elegant design and complete product catalog features." },
        p17: { name: "Website PT.Cipta Hospital", status: "I created this website to promote PT. Cipta Hospital, in terms of services, etc. and this is to complete a project for a college assignment." },
        p18: { name: "Login Register", status: "A responsive Login & Register interface implementation." },
      },
    },
  },
  id: {
    translation: {
      ...
      projectList: {
        ...
        p12: { name: "Parfume Lux", status: "Website toko online parfum dengan desain elegan dan fitur katalog produk yang lengkap." },
        p13: { name: "Website PT.Cipta Hospital", status: "Saya membuat website ini untuk mempromosikan PT. Cipta Hospital, dalam hal layanan, dll. dan ini untuk menyelesaikan proyek tugas kuliah." },
        p14: { name: "Login Register", status: "Implementasi antarmuka Login & Register yang responsif." },
        p15: { name: "Aplikasi Absensi Siswa", status: "Aplikasi absensi siswa berbasis web untuk memudahkan pencatatan kehadiran siswa secara digital dengan fitur lengkap dan antarmuka modern." },
        p16: { name: "Aplikasi CBT Siswa", status: "Aplikasi Computer Based Test (CBT) siswa berbasis web untuk melaksanakan ujian secara online dengan fitur manajemen soal dan penilaian otomatis." },
        p17: { name: "MangaBurn", status: "Platform baca manga & komik modern dengan fitur lengkap untuk manajemen komik, bookmark, history baca, dan sistem rating." },
      },
    },
  },
  jp: {
    translation: {
      ...
      projectList: {
        ...
        p4: { name: "ポートフォリオV3 Yae", status: "モダンなデザインと向上したユーザー体験を備えた個人ポートフォリオウェブサイトの最新バージョン。" },
        p5: { name: "ジョキリストサイト", status: "ゲームアカウント管理サービスを提供するために作成されたウェブサイト：デイリーログイン、レベリング、週間イベント。安全、迅速、信頼性。" },
        p6: { name: "白織ジョキV2", status: "ゲームアカウントサービス向けのデザインと機能が改善されたShiraori Jokiウェブサイトの第2バージョン。" },
        p7: { name: "PKMプロジェクト", status: "学生の創造性と革新を紹介するPKM（学生創造性プログラム）プロジェクトのウェブサイト。" },
        p8: { name: "Eコマースダッシュボード", status: "在庫、販売、レポートの完全な機能を備えた生鮮食品管理用Eコマースダッシュボード。" },
        p9: { name: "Lumichan AI", status: "インテリジェントな会話機能とモダンなユーザーインターフェースを備えたAI搭載チャットボットアプリケーション。" },
        p10: { name: "デジタル図書館", status: "モダンなインターフェースで本のコレクションを整理・管理するデジタル図書館管理システム。" },
        p11: { name: "Aplikasi Absensi Siswa", status: "完全な機能とモダンなインターフェースを備えた、デジタル生徒出席記録を容易にするウェブベースの生徒出席アプリケーションです。" },
        p12: { name: "Aplikasi CBT Siswa", status: "問題管理と自動採点機能を備えた、オンライン試験を実施するためのウェブベースのコンピュータベーステスト（CBT）学生アプリケーションです。" },
        p13: { name: "MangaBurn", status: "漫画管理、ブックマーク、閲覧履歴、評価システムを完備したモダンな漫画＆コミック読書プラットフォーム。" },
        p14: { name: "Traffic RNN", status: "インテリジェントな交通分析のためのリカレントニューラルネットワーク（RNN）を使用した交通予測アプリケーション。" },
        p15: { name: "SawitMart", status: "AngularとGolangをSawitDBと共に使用して開発されたウェブアプリケーション。" },
        p16: { name: "Parfume Lux", status: "エレガントなデザインと充実した商品カタログ機能を備えた香水オンラインストアサイト。" },
        p17: { name: "PT.Cipta Hospital", status: "PT. Cipta Hospitalのサービスなどを宣伝するために作成しました。これは大学の課題プロジェクトを完了するためのものです。" },
        p18: { name: "ログイン登録", status: "レスポンシブなログイン＆登録インターフェースの実装。" },
      },
    },
  },
};
