  ...
  en: {
    translation: {
      ...
      projectList: {
        ...
        p12: { name: "Parfume Lux", status: "Online perfume store website with elegant design and complete product catalog features." },
        p13: { name: "Website PT.Cipta Hospital", status: "I created this website to promote PT. Cipta Hospital, in terms of services, etc. and this is to complete a project for a college assignment." },
        p14: { name: "Login Register", status: "A responsive Login & Register interface implementation." },
        p15: { name: "Aplikasi Absensi Siswa", status: "A web-based student attendance application to facilitate digital student attendance recording with complete features and modern interface." },
        p16: { name: "Aplikasi CBT Siswa", status: "A web-based Computer Based Test (CBT) student application for conducting online exams with question management and automatic grading features." },
        p17: { name: "MangaBurn", status: "Modern manga & comic reading platform with complete features for comic management, bookmarking, reading history, and rating system." },
      },
    },
  },
  id: {
  ...
  jp: {
    translation: {
      ...
      projectList: {
        ...
        p12: { name: "Parfume Lux", status: "エレガントなデザインと充実した商品カタログ機能を備えた香水オンラインストアサイト。" },
        p13: { name: "PT.Cipta Hospital", status: "PT. Cipta Hospitalのサービスなどを宣伝するために作成したウェブサイト。大学の課題プロジェクトを完了するためのものです。" },
        p14: { name: "ログイン登録", status: "レスポンシブなログイン＆登録インターフェースの実装。" },
        p15: { name: "Aplikasi Absensi Siswa", status: "完全な機能とモダンなインターフェースを備えた、デジタル生徒出席記録を容易にするウェブベースの生徒出席アプリケーションです。" },
        p16: { name: "Aplikasi CBT Siswa", status: "問題管理と自動採点機能を備えた、オンライン試験を実施するためのウェブベースのコンピュータベーステスト（CBT）学生アプリケーションです。" },
        p17: { name: "MangaBurn", status: "漫画管理、ブックマーク、閲覧履歴、評価システムを完備したモダンな漫画＆コミック読書プラットフォーム。" },
      },
    },
  },
};
