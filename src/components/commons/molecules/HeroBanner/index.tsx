...
import Banner from "/images/bg-3.png";
  ...
  return (
    <section className="relative h-[460px] w-full rounded-4xl">
      ...
      <div
        ...
        onClick={() => {
          window.location.href =
            "mailto:ilhambustomi54@gmail.com?subject=Subject&body=message%20goes%20here";
        }}
      >
      ...
      <div className="absolute right-4 bottom-4 flex flex-col gap-4 max-md:bottom-14">
        <CardMedium
          title="About"
          bgImg={`/images/ilham-bustomi-about.JPG`}
          onClick={() => navigate("/about")}
        />

        <CardMedium
          title="Skills"
          bgImg={`/images/ilham-bustomi-profile.JPG`}
